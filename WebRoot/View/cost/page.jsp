...
<script src="<%=basePath%>content/js/loading.js"
	type="text/javascript"></script>
</head>
<body onload="doReady()">
<jsp:include page="../shared/manager_head.jsp"></jsp:include>
<div id="loading"  style="position:absolute;top:200px;left:200px;height:25px;width:50px;"><img src="<%=basePath %>content/images/loading.gif"/></div>  <!-- 未加载完毕时显示图片 -->
	<div class="manager_main">
		<div class="content">
		  <div class="leftbox">
				<!-- Begin of  #contentlist -->
				<div class="contentBox">
                  <div id="container" style="width: 550px; height: 400px; margin: 5px auto">
                 </div>
            </div>

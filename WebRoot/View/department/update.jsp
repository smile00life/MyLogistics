			...
			<div class="leftbox">
				...
				<div class="contentBox">
					...
					<div class="innerContent">
						<form action="<%=basePath%>department/updateDepartment" method="post">
							<table class="aTable">
								<tr>
                                    <%-- <input type="hidden"  name="manager_id" value="${manager_id}"/> --%>
                                    <input type="hidden"  name="manager_name" value="${manager_name}"/>
                                    <input type="hidden"  name="department_id" value="${departmentInfo.department_id} "/>
                                    <input type="hidden"  name="ranger_id" value="${departmentInfo.ranger_id} "/>
                                    <input type="hidden"  name="department_upId" value="100"/>
								</tr>
								<tr>
							...
							<tr>
								...
								<td colspan="3"><input type="text" value="${departmentInfo.department_name }" name="department_name" style="width: 400px;" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" name="department_code" value="${departmentInfo.department_code }"/></td>
								<td class="sTitle"><span class="important">*</span>负责人:</td>
								<td><input type="text" name="department_manager" value="${departmentInfo.department_manager }"/></td>
							</tr>
							<tr>
								<td class="sTitle">联系方式1-座机:</td>
								<td colspan="3"><input type="text" name="department_tel" value="${departmentInfo.department_tel }"/></td>
							</tr>
							<tr>
								<td class="sTitle"><span class="important">*</span>联系方式2-手机:</td>
								<td colspan="3"><input type="text" name="department_mobile"  value="${departmentInfo.department_mobile }"/></td>
							</tr>
							<tr>
								<td class="sTitle"><span class="important">*</span>地址:</td>
								<td colspan="3"><input type="text" style="width: 490px;" name="department_address" value="${departmentInfo.department_address }"/></td>
							</tr>
							<tr class="sSubmit">

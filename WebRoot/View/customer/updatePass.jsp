			...
			<div class="leftbox">
				...
				<div class="contentBox">
					...
					<div class="innerContent">
						<form action="<%=basePath%>customer/UpdateUserPass" method="post">
							<table class="aTable">
								<%-- <tr>
								...
								<tr class="aSubmit">
									<td><input type="submit" class="from_sub" value="提交" onclick="return checkinput()"/></td>

					...
					<div class="innerContent">
						<form action="<%=basePath%>customer/createCustomer" method="post">
							<table class="aTable">
								...
								<td ><input type="text" name="customer_name" style="width: 400px;" /></td>
							</tr>
							<tr>
								<td class="sTitle"><span class="important">*</span>身份证号:</td>
								<td ><input type="text" name="customer_code" style="width: 400px;" /></td>
							</tr>
							<tr>
								<span class="important">*</span><td class="sTitle">居住地址:</td>
								<td >
								     <input type="text" name="customer_address" style="width: 400px;" />
                                </td>
							</tr>
							<tr>
								<td class="sTitle"><span class="important">*</span>订单序号:</td>
								<td ><input type="text" name="order_id" style="width: 400px;" /></td>
							</tr>
							<tr>
								<td class="sTitle"><span class="important">*</span>联系方式一(手机):</td>
								<td ><input type="text" name="customer_tel" style="width: 400px;" /></td>
							</tr>
							<tr>
								<td class="sTitle"><span class="important">*</span>联系方式二(座机):</td>
								<td ><input type="text" name="customer_mobile" style="width: 400px;" /></td>
							</tr>

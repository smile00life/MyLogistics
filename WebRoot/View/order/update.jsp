	...
	//$(function() {--修改这里
		$("#citylist").change(
				function() { //当城市选项改变时激活
					...
					var url ="<%=basePath%>department/getAreaJsonDataByCityId";   //参数依次类型(action,Controller,area）            
					...
					<div class="innerContent">
						<form action="<%=basePath%>order/updateOrder" method="post">
							<table class="aTable">
								...
								<tr>
								<td class="sTitle"><span class="important">*</span>货物名称:</td>
								<td colspan="3"><input value="${orderinfo.goods_name}" type="text" name="goods_name" style="width: 200px;" /></td>
							    </tr>
								<tr>
								<span class="important">*</span><td class="sTitle">客户姓名:</td>
								<td colspan="3">
								     <select id="userlist" name="sender_user">
								     <option value="${orderinfo.sender_user}">${orderinfo.sender_user}</option>
							    ...
							    <tr>
								<td class="sTitle"><span class="important">*</span>收货人姓名:</td>
								<td colspan="3"><input type="text" value="${orderinfo.receiver_user}" name="receiver_user" style="width: 200px;" /></td>
							    </tr>
							    <tr>
								<td class="sTitle"><span class="important">*</span>收货人联系方式:</td>
								<td colspan="3"><input type="text" value="${orderinfo.receiver_tel}" name="receiver_tel" style="width: 200px;" /></td>
							    </tr>
								<tr>
								<td class="sTitle"><span class="important">*</span>收货人所在地:</td>
								<td colspan="3">
								<select id="citylist" name="city_name">
								<option selected value="${orderinfo.city_name }">${orderinfo.city_name }</option>
								...
								<select id="arealist" name="area_name">
								 <option selected value="${orderinfo.area_name }">${orderinfo.area_name }</option>
								<option value="-1">请选择</option>
							...
							<tr>
								<td class="sTitle"><span class="important">*</span>详细地址:</td>
								<td colspan="3"><input type="text" value="${orderinfo.receiver_address}" name="receiver_address" style="width: 200px;" /></td>
							</tr>
							<tr>
								<td class="sTitle"><span class="important">*</span>邮编:</td>
								<td colspan="3"><input type="text" value="${orderinfo.receiver_post}" name="receiver_post" style="width: 200px;" /></td>
							</tr>
							<tr>
								<span class="important">*</span><td class="sTitle">揽件员:</td>
								<td colspan="3">
								     <select id="receiver_employee" name="receiver_employee">
								     <option value="${orderinfo.receiver_employee}">${orderinfo.receiver_employee}</option>
							...
							<tr>
								<span class="important">*</span><td class="sTitle">派送员:</td>
								<td colspan="3">
								     <select id="sender_employee" name="sender_employee">
								     <option value="${orderinfo.sender_employee}">${orderinfo.sender_employee}</option>
							...
							<tr>
								<span class="important">*</span><td class="sTitle">订单状态:</td>
								<td colspan="3">
								     <select id="order_pay" name="order_pay">
								     <option value="${orderinfo.order_pay}">${orderinfo.order_pay}</option>
							...
							<td  class="order_money">总金额：</td><td class="order_td"><input value="${orderinfo.order_money}" type="text" name="order_money" style="width: 200px;" /> </td></tr>
							<tr class="sSubmit">

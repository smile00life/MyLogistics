			...
			<div class="leftbox">
				...
				<div class="contentBox">
					...
					<div class="innerContent">
						<form action="<%=basePath%>order/updateGoods" method="post">
							<table class="aTable">
								<tr>
								...
								<td colspan="3"><input value="${goodsinfo.goods_name}" type="text" name="goods_name" style="width: 400px;" /></td>
							    </tr>
								
							    <tr>
								<td class="sTitle"><span class="important">*</span>商品内容:</td>
								<td colspan="3"><input value="${goodsinfo.goods_content}" type="text" name="goods_content" style="width: 400px;" /></td>
							    </tr>
							    <tr>
								<td class="sTitle"><span class="important">*</span>商品重量:</td>
								<td colspan="3"><input value="${goodsinfo.goods_weight}" type="text" name="goods_weight" style="width: 400px;" /></td>
							    </tr>
								<tr>
								<td class="sTitle"><span class="important">*</span>商品类型:</td>
								<td colspan="3"><input value="${goodsinfo.goods_type}" type="text" name="goods_type" style="width: 400px;" /></td>
							    </tr>
							    <tr class="sSubmit">

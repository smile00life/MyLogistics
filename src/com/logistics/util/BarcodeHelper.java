...
public class BarcodeHelper {
	 ...
	 */
	// 条形码EAN13长度
	public static String createBarCode13(String savePath, String jbarCode,
			String imgFormat) {
	...
	// 生成15位条形码方法
	public static String createBarCode15(HttpServletRequest request,String uploadPath, String jbarCode,
			String imgFormat) {
		...
		try {
			...
			//添加服务器地址
			String savePath = setrootPath(request, uploadPath);
			
			//添加图片下载地址
			String ImgPaths = uploadPath + imgName + "." + imgFormat;
			
			// 保存二维码图片,图片完整地址imgPath
	...
	public static String createBarCode15(HttpServletRequest request,
		...
		//在地址前增加服务器地址
		String uploadPath =path + "\\" + uploadSaveFolder + "\\";
		...
		return createBarCode15(request,uploadPath, jbarCode, ImageUtil.JPEG);
	}
	...
	public static String createBarCode13(HttpServletRequest request,
		...
		return createBarCode13(uploadPath, jbarCode, ImageUtil.JPEG);
	}
	...
	//外部访问权
	public static String setrootPaths(HttpServletRequest request, String mypath) {
		// 获得服务器的名字
